...
static PyObject *fmkit_cutils_dtw( PyObject *self, PyObject *args ) {
	...
	if (!PyArg_ParseTuple(args, "OOiiiifOOOOOOO", &arg1, &arg2, &d, &l1, &l2, &window, &penalty,
		...
		//printf("fmkit_cutils_dtw() invalid arguments!!!");
		return NULL;
	}
	...
	//printf("fmkit_cutils_dtw() array parsing finishes.\n");
/*
	matrix_dims[0] = l1 + 1;
	matrix_dims[1] = l2 + 1;
	...
	//printf("fmkit_cutils_dtw() memory allocation finishes.\n");
*/
	...
	//printf("fmkit_cutils_dtw() argument ready.\n");
	...
	//printf("fmkit_cutils_dtw() results ready.\n");
...
static char fmkit_cuitls_docs[] =
	"dtw_c(): Dynamic Time Warping implemented in C\n";

static PyMethodDef fmkit_cutils_methods[] = {
	{"dtw_c",  fmkit_cutils_dtw, METH_VARARGS, fmkit_cuitls_docs},
	{NULL, NULL, 0, NULL}        // Sentinel
};

//PyMODINIT_FUNC init_cutils()  {
//	Py_InitModule3("cutils", cutils_methods);
//	//import_array();  // Must be present for NumPy.  Called first after above line.
//}

static struct PyModuleDef fmkit_cuitls =
{
    PyModuleDef_HEAD_INIT,
    "fmkit_cutils", /* name of module */
    "Utility functions of fmkit package\n", /* module documentation, may be NULL */
    -1,   /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    fmkit_cutils_methods
};

PyMODINIT_FUNC PyInit_fmkit_cutils(void)
{
	import_array();  // Must be present for NumPy.  Called first after above line.
    return PyModule_Create(&fmkit_cuitls);
}
